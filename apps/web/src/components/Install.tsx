...
const HOMEBREW_ROWS: { label: string; cmd: string }[] = [
  { label: "1. Install", cmd: "brew install tlgimenes/recall/recall-cli" },
  { label: "2. Register", cmd: "claude mcp add recall --scope user -- recall mcp" },
];
  ...
  return (
    <section id="install" className="mx-auto max-w-3xl px-6 py-20">
      ...
      <p className="mt-3 text-center text-sm text-[var(--color-muted)]">
        v0.1.0 is out — grab the binary below. The npm and plugin-store packages are
        still on the way.
      </p>
